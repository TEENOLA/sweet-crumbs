...
function Hero() {
  return (
    <section className="relative flex items-center justify-center overflow-hidden py-28 md:py-36">
      ...
      <div className="relative z-10 px-8 md:px-16 lg:px-24 max-w-4xl mx-auto text-center flex flex-col items-center">
        <FadeIn>
        ...
        <FadeIn delay={100}>
          <h1 className="font-playfair font-bold text-[clamp(2.75rem,6vw,5rem)] text-[#2b2118] leading-[1.1] mb-6">
            Baked with love,{" "}
            <span className="text-[#d9542d]">served with joy.</span>
          </h1>
        </FadeIn>
        <FadeIn delay={200}>
          <p className="font-inter text-[16px] text-[#6b5a45] leading-relaxed mb-8 max-w-xl mx-auto">
